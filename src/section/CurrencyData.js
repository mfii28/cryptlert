...
const CurrencyData = () => {
  ...
  return (
    <Box sx={{p: 3, height: "100%", display: "flex", flexDirection: "column"}}>
      ...
      <Box sx={{ display: "flex", flexDirection: "column" }} className="statBar">
      <Box className="statBarHeader" sx={{ mt: 2, width: "100%", display: "flex", alignItems: "center", color: "#dfdfdf" }}>
          <StatBarHeader 
        ...
        <Box className="statBarContent" sx={{ display: "flex", justifyContent: "space-between", color: "#dfdfdf" }}>
  <Box className="numbers" sx={{ px: 2, py: 1.7, width: "100%" }}>
  ...
  variant="determinate"
  color="primary"
  value={Number(supplyPercent.current)}
  sx={{
    bgcolor: "rgb(37,41,60)",
    width: "40%",
    borderRadius: "25px",
